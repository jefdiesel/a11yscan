...
<section>
    ...
    <div class="grid">
        <article class="card blog-card" tabindex="0" id="article-user-rights-accessibility">
            ...
            <a href="https://a11yscan.xyz/blog/posts/understanding-user-rights-accessibility.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-disability-rights">
            ...
            <a href="https://a11yscan.xyz/blog/posts/disability-rights-by-state.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-finding-legal-support">
            ...
            <a href="https://a11yscan.xyz/blog/posts/finding-legal-support.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-serial-filers">
            ...
            <a href="https://a11yscan.xyz/blog/posts/serial-filers-enforcement-gap.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-lawsuit-trends-2024">
            ...
            <a href="https://a11yscan.xyz/blog/posts/2024-lawsuit-trends.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-2024-settlements">
            ...
            <a href="https://a11yscan.xyz/blog/posts/major-2024-settlements.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-2025-predictions">
            ...
            <a href="https://a11yscan.xyz/blog/posts/2025-predictions.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-platform-liability">
            ...
            <a href="https://a11yscan.xyz/blog/posts/platform-liability.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-litigation-defense">
            ...
            <a href="https://a11yscan.xyz/blog/posts/litigation-defense-strategies.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-risk-management">
            ...
            <a href="https://a11yscan.xyz/blog/posts/accessibility-risk-management.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-ada-lawsuits-2025">
            ...
            <a href="https://a11yscan.xyz/blog/posts/ada-lawsuits-2025.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
    </div>
</section>
...
<section>
    ...
    <div class="grid">
        <article class="card blog-card" tabindex="0" id="article-blind-users">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-blind-users.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-low-vision-users">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-low-vision-users.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-deaf-users">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-deaf-users.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-motor-disability">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-motor-disability.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-cognitive-disabilities">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-cognitive-disabilities.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-neurodivergent-users">
            ...
            <a href="https://a11yscan.xyz/blog/posts/designing-for-neurodivergent-users.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
    </div>
</section>
...
<section>
    ...
    <div class="grid">
        <article class="card blog-card" tabindex="0" id="article-accessibility-statements">
            ...
            <a href="https://a11yscan.xyz/blog/posts/accessibility-statements.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-document-barriers">
            ...
            <a href="https://a11yscan.xyz/blog/posts/document-report-barriers.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-wcag-levels">
            ...
            <a href="https://a11yscan.xyz/blog/posts/wcag-2-1-levels-guide.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-color-contrast">
            ...
            <a href="https://a11yscan.xyz/blog/posts/color-contrast-guide.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-keyboard-navigation">
            ...
            <a href="https://a11yscan.xyz/blog/posts/keyboard-navigation-guide.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-alt-text">
            ...
            <a href="https://a11yscan.xyz/blog/posts/alt-text-guide.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-ada-legal">
            ...
            <a href="https://a11yscan.xyz/blog/posts/ada-legal-requirements.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-aria-semantic">
            ...
            <a href="https://a11yscan.xyz/blog/posts/aria-semantic-html-guide.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-overlays-fail">
            ...
            <a href="https://a11yscan.xyz/blog/posts/accessibility-overlays-fail.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-silver-economy">
            ...
            <a href="https://a11yscan.xyz/blog/posts/silver-economy-accessibility.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-temp-disabilities">
            ...
            <a href="https://a11yscan.xyz/blog/posts/temp-disabilities-broken-mouse.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-seo-wcag-linked">
            ...
            <a href="https://a11yscan.xyz/blog/posts/seo-wcag-linked.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-div-soup">
            ...
            <a href="https://a11yscan.xyz/blog/posts/div-soup-cost-analysis.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-accessibility-demand-letter">
            ...
            <a href="https://a11yscan.xyz/blog/posts/accessibility-demand-letter.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-wcag-2-2">
            ...
            <a href="https://a11yscan.xyz/blog/posts/wcag-2-2-changes.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-mobile-accessibility">
            ...
            <a href="https://a11yscan.xyz/blog/posts/mobile-accessibility.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-platform-responsibility">
            ...
            <a href="https://a11yscan.xyz/blog/posts/platform-responsibility-liability.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
        ...
        <article class="card blog-card" tabindex="0" id="article-widget-seller-responsibility">
            ...
            <a href="https://a11yscan.xyz/blog/posts/widget-seller-responsibility.php" class="btn btn-primary" style="margin-top: 1rem;">Read More</a>
        </article>
    </div>
</section>
